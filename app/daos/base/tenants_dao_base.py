...
class TenantsDaoBase(BaseDao[Tenants]):
    ...
    Provides CRUD operations and utility methods for Tenants table.
    """
    model = Tenants
    ...
    def create(
        ...
        """
        Create a new Tenants record in the database.

        Args:
            db_session (Session): SQLAlchemy database session.
            data (Union[Tenants, dict]): Data to create the record. Accepts model instance or dictionary.

        Returns:
            Tenants: The created Tenants instance.
    ...
    def delete(
        ...
        """
        Delete the specified Tenants instance from the database.

        Args:
            db_session (Session): SQLAlchemy database session.
            instance (Tenants): The instance to be deleted.
    ...
    def get_by_key(
        ...
        Returns:
            List[Tenants]: List of matching records.
        """
    ...
    def get(
        ...
        Returns:
            Optional[Tenants]: The matched record, or None if not found.
        """
...
, id=id        )
    ...
    def get_all(
        ...
        Returns:
            List[Tenants]: List of retrieved records.
        """
    ...
    def update(
        ...
        Returns:
            Optional[Tenants]: The updated instance, or None if not found.
        """
