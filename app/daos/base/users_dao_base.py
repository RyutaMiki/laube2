...
class UsersDaoBase(BaseDao[Users]):
    """
    Data Access Object for Users.
    Provides CRUD operations and utility methods for Users table.
    """
    model = Users
    ...
    def create(
        self,
        db_session: Session,
        data: Union[Users, dict]
    ) -> Users:
        """
        Create a new Users record in the database.

        Args:
            db_session (Session): SQLAlchemy database session.
            data (Union[Users, dict]): Data to create the record. Accepts model instance or dictionary.

        Returns:
            Users: The created Users instance.

        Raises:
            RuntimeError: If the creation fails.
        """
        try:
            instance = Users(**data) if isinstance(data, dict) else data
    ...
    def delete(
        ...
        """
        Delete the specified Users instance from the database.

        Args:
            db_session (Session): SQLAlchemy database session.
            instance (Users): The instance to be deleted.
    ...
    def get_by_key(
        ...
        Returns:
            List[Users]: List of matching records.
        """
    ...
    def get(
        self,
        db_session: Session,
        id: Optional[int]    ) -> Optional[Users]:
        """
        ...
        Returns:
            Optional[Users]: The matched record, or None if not found.
        """
...
, id=id        )
    ...
    def get_all(
        ...
        Returns:
            List[Users]: List of retrieved records.
        """
    ...
    def update(
        ...
        Returns:
            Optional[Users]: The updated instance, or None if not found.
        """
