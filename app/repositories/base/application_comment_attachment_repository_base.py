...
class ApplicationCommentAttachmentRepositoryBase(BaseRepository):
    def __init__(self, dao: Optional[ApplicationCommentAttachmentDaoBase] = None):
        self.dao = dao or ApplicationCommentAttachmentDaoBase()
