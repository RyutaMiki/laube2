...
class ApplicationCommentReadStatusRepositoryBase(BaseRepository):
    def __init__(self, dao: Optional[ApplicationCommentReadStatusDaoBase] = None):
        self.dao = dao or ApplicationCommentReadStatusDaoBase()
