...
class ApplicationCommentRepositoryBase(BaseRepository):
    def __init__(self, dao: Optional[ApplicationCommentDaoBase] = None):
        self.dao = dao or ApplicationCommentDaoBase()
