...
class ApplicationObjectRepositoryBase(BaseRepository):
    def __init__(self, dao: Optional[ApplicationObjectDaoBase] = None):
        self.dao = dao or ApplicationObjectDaoBase()
