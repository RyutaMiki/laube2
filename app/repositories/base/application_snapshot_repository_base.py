...
class ApplicationSnapshotRepositoryBase(BaseRepository):
    def __init__(self, dao: Optional[ApplicationSnapshotDaoBase] = None):
        self.dao = dao or ApplicationSnapshotDaoBase()
