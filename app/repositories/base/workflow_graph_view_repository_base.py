...
class WorkflowGraphViewRepositoryBase(BaseRepository):
    def __init__(self, dao: Optional[WorkflowGraphViewDaoBase] = None):
        self.dao = dao or WorkflowGraphViewDaoBase()
